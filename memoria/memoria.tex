...
% TODO, NO SE ME OCURRE QUÉ MÁS DECIR
...
\begin{figure}[H]
    \makebox[\textwidth][c]{
        ...
        % \includegraphics[width=14cm]{omp/omp_hilos_svg/omp_grey.svg}
    }
...
\begin{figure}[H]
	\makebox[\textwidth][c]{
        ...
        %\includegraphics[width=14cm]{omp/omp_hilos_svg/omp_color_total.svg}
    }
...
\begin{figure}[H]
	\makebox[\textwidth][c]{
        ...
        % \includegraphics[width=14cm]{omp/omp_hilos_svg/omp_hsl_proc.svg}
    }
...
\begin{figure}[H]
	\makebox[\textwidth][c]{
        ...
        % \includegraphics[width=14cm]{omp/omp_hilos_svg/omp_yuv_proc.svg}
    }
...
\begin{figure}[H]
	\makebox[\textwidth][c]{
        \includesvg[width=15cm]{comb/amdalh_comb_todo.svg}
        % \includegraphics[width=14cm]{omp/omp_hilos_svg/amdalh_omp_todo.svg}
    }
